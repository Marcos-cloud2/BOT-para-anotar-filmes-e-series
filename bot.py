...
RESPONSE_FORMAT = (
    ...
    "TITULO: <titulo oficial usado nas plataformas de streaming ocidentais "
    "(ex: Crunchyroll, Netflix, Prime Video). Para animes, isso costuma ser "
    "um titulo em ingles diferente do nome japones original ou romanizado "
    "(ex: 'From Overshadowed to Overpowered', nao 'Rakudai Kenja no Gakuin "
    "Musou'). Pesquise ativamente qual nome a plataforma de streaming usa "
    "antes de responder; so use o titulo japones/original se nao existir "
    "nome ocidental oficial>\n"
